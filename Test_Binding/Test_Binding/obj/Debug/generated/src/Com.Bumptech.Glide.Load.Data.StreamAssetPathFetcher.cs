...
namespace Com.Bumptech.Glide.Load.Data {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.data']/class[@name='StreamAssetPathFetcher']"
	[global::Android.Runtime.Register ("com/bumptech/glide/load/data/StreamAssetPathFetcher", DoNotGenerateAcw=true)]
	public partial class StreamAssetPathFetcher : global::Com.Bumptech.Glide.Load.Data.AssetPathFetcher {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/bumptech/glide/load/data/StreamAssetPathFetcher", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (StreamAssetPathFetcher); }
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.data']/class[@name='StreamAssetPathFetcher']/constructor[@name='StreamAssetPathFetcher' and count(parameter)=2 and parameter[1][@type='android.content.res.AssetManager'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Landroid/content/res/AssetManager;Ljava/lang/String;)V", "")]
		public unsafe StreamAssetPathFetcher (global::Android.Content.Res.AssetManager p0, string p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (StreamAssetPathFetcher)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Bumptech.Glide.Load.Data.StreamAssetPathFetcher __this = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Data.StreamAssetPathFetcher> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.data']/class[@name='StreamAssetPathFetcher']/method[@name='close' and count(parameter)=1 and parameter[1][@type='java.io.InputStream']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.data']/class[@name='StreamAssetPathFetcher']/method[@name='loadResource' and count(parameter)=2 and parameter[1][@type='android.content.res.AssetManager'] and parameter[2][@type='java.lang.String']]"
		[Register ("loadResource", "(Landroid/content/res/AssetManager;Ljava/lang/String;)Ljava/io/InputStream;", "GetLoadResource_Landroid_content_res_AssetManager_Ljava_lang_String_Handler")]
		protected virtual unsafe global::System.IO.Stream LoadResource (global::Android.Content.Res.AssetManager p0, string p1)
		{
			if (id_loadResource_Landroid_content_res_AssetManager_Ljava_lang_String_ == IntPtr.Zero)
				id_loadResource_Landroid_content_res_AssetManager_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "loadResource", "(Landroid/content/res/AssetManager;Ljava/lang/String;)Ljava/io/InputStream;");
			IntPtr native_p1 = JNIEnv.NewString (p1);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (p0);
				...
				if (GetType () == ThresholdType)
					__ret = global::Android.Runtime.InputStreamInvoker.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_loadResource_Landroid_content_res_AssetManager_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Android.Runtime.InputStreamInvoker.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "loadResource", "(Landroid/content/res/AssetManager;Ljava/lang/String;)Ljava/io/InputStream;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
			}
